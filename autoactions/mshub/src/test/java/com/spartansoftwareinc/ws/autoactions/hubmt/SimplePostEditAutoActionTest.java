...
//            "The URL is {1}https://www.youtube.com/watch?v=abc212_AVC{2}.");
        ...
        final List<SimplePostEditAutoActionYAMLConfig.Action> germanGermanyActions = config.getActionsForLanguage(
            "German (Germany)");
        testUpdate(germanGermanyActions, "https://www.youtube.com/watch?v=abc212_AVC",
            "https://www.youtube.com/watch?v=abc212_AVC");
        testUpdate(germanGermanyActions, "The URL is {1}https://www.youtube.com/watch?v=abc212_AVC{2}. This: is a "
                + "sentence?",
            "The URL is {1}https://www.youtube.com/watch?v=abc212_AVC{2}. This: is a sentence?");
    }
